                    ...
                    <div class="card-body">
                        ...
                        <hr class="mb-5"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="John Smith" value="{{ $user->name }}">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="email" name="email" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="example@app.com" value="{{ $user->email }}">
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback">
